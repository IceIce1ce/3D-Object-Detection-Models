...
class Trainer(object):
    def __init__(self, cfg, model, optimizer, train_loader, lr_scheduler, warmup_lr_scheduler, logger, loss, model_name, dist_train=False, tb_log=None, rank=0):
        self.cfg = cfg
        self.model = model
        ...
        if cfg.get('pretrain_model'):
            ...
            load_checkpoint(model=self.model, optimizer=None, filename=cfg['pretrain_model'], map_location=self.device, logger=self.logger, to_cpu=self.dist_train)
