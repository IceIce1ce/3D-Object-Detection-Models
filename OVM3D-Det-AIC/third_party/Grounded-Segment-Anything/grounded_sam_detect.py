...
TEXT_PROMPT_DICT = {'KITTI': "pedestrian. car. cyclist. van. truck",
                    ...
                    'Warehouse_008': "person. forklift. novacarter. transporter. fouriergr1t2. agilitydigit",}
...
for mode in ['train', 'val']:
    ...
    for k in tqdm(range(len(data['images']))):
        ...
        boxes, logits, phrases, features, encoded_text, non_zero_idx_list, logits_all = predict(model=groundingdino_model, image=image, caption=TEXT_PROMPT, box_threshold=BOX_TRESHOLD, text_threshold=TEXT_TRESHOLD)
