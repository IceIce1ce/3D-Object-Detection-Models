...
TEXT_PROMPT_DICT = {'KITTI': "ground", 'nuScenes': "ground", 'ARKitScenes': "floor", 'SUNRGBD': "floor", 'Warehouse_008': 'floor'}
...
for mode in ['train', 'val']:
    ...
    for k in tqdm(range(len(data['images']))):
        ...
        boxes, logits, phrases, features, encoded_text, non_zero_idx_list, logits_all = predict(model=groundingdino_model, image=image, caption=TEXT_PROMPT,
